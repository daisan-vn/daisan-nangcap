<div id="suggest" class="suggest">
    ...
    <div class="suggest__historysearch">
        ...
        <ul class="nav px-3">
            ...
            <li class="nav-item d-flex justify-content-between"><a class="historysearch__key" href="{$arg.domain}product?k={$data}&t=0">{$data}&nbsp;<svg
                        xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
    ...
    <ul class="suggest__collections nav px-3 row row-nm">
        ...
        <li class="nav-item col-md-4 mb-3">
            <a href="javascript:void(0)" class="collections-item nav-link" onclick="set_search_cate({$data.id})">
                <div class="img-col"><img src="{$data.thumb}" class="img-fluid"></div>
                <div class="info-col">
    ...
    <ul class="nav px-3">
        ...
        <li class="nav-item d-flex justify-content-between">
            <a class="trendsearch__key" href="{$arg.domain}product?k={$data.name}&t=0"><img src="{$data.avatar}" class="img-item rounded-circle" width="50" height="50">{$data.name}</a>
        </li>
        {/foreach}
    </ul>
</div>