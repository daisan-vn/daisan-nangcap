...
-->
    <div class="container-fluid">
        <div class="banner mb-3">
            ...
            <img src="{$data.image}" class="w-100"> {/if} {/foreach}
        </div>
                ...
                <div class="item card rounded-8">
                    <div class="product-list-recommend">
                        ...
                        <div class="list-item-info">
                            ...
                            <p class="pt-1"><a href="{$v.url_page}?{$v.url_ads}" class="text-oneline" title="{$v.metas.page}">{$v.metas.page}</a>
                            </p>
                        </div>
                    </div>
                    <span class="ads_product_label">Đề xuất</span>
                </div>
                {/foreach} {if $out.isads neq 1 && count($ads) gt 30}
        ...
        <div class="row row-nm">
            ...
            <div class="col-xl-10 overflow-hidden">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="item-col swiper-item-keyword">
                                            <!-- <div class="image-tag__img">
                                                <a href="{$v.url}"><img src="{$v.image}" class="img-fluid rounded-circle"></a>
                                            </div> -->
                ...
                <div class="d-flex pl-3 py-3 pr-0 refine-filters__result-section">
                    ...
                    <div class="refine-filters__result-right">
                        <ul class="nav">
                            ...
                            <li class="nav-item"><a href="./product?k={$smarty.get.k}&t=0&type=grid" class="nav-link text-dark active"><i class="fa fa-th-large"
										aria-hidden="true"></i></a></li>
                            <li class="nav-item"><a href="./product?k={$smarty.get.k}&t=0&type=list" class="nav-link text-dark"><i class="fa fa-list-ul" aria-hidden="true"></i></a></li>
                ...
                <div class="search-result__content view-grid">
                    <div class="row row-nm">
                        {if $out.isads neq 1} {foreach from=$top key=k item=v}
                                    ...
                                    <div class="product-list-recommend">
                                        <div class="item-img">
                                            ...
                                            <div class="owl-carousel owl__product-search">
                                                ...
                                                <div class="item">
                                                    <a href="{$v.url}?{$v.url_ads}"><img data-src="{$img}" class="img-fluid zoom-in" loading="lazy"></a>
                                                </div>
                                                {/foreach}
                                            </div>
                                            {else}
                                            <div class="item">
                                                <a href="{$v.url}?{$v.url_ads}"><img data-src="{$v.a_img[0]}" class="img-fluid zoom-in" loading="lazy"></a>
                                            </div>
                                            {/if}
                                        </div>
                                        <div class="search-item-info">
                                            <h3 class="text-nm-1 pt-2"><a href="{$v.url}?{$v.url_ads}" class="text-twoline text-dark">{$v.name}</a></h3>
                                            ...
                                            <p class="product-item-order mb-3"><b>{$v.minorder} {$v.metas.unit}</b> (Min Order)
                                            </p>
                                            <div class="seller-info d-none d-sm-block">
                                                <div class="media mb-2">
                                                    <div class="media-body">
                                                        <h3 class="mt-0 text-oneline seller-intro-title">
                                                            <a href="{$v.url_page}?{$v.url_ads}" title="{$v.metas.page}">{$v.metas.page}</a>
                                                        </h3>
                                                        <span class="yrs mr-2">
															<b
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="">
                                                    <a href="{$v.url_rfq}&{$v.url_ads}" class="btn btn-sm btn-contact rounded-pill">Liên hệ nhà cung
														cấp</a>
                                                </div>
                                                <div class="px-2 d-none d-sm-block">
                                                    <a href="{$v.url_addcart}&{$v.url_ads}"><i class="fa fa-plus"></i>
														Đặt hàng</a>
                                                </div>
                                                <span class="search-ads">Top</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <!--end col-3-->
                        {/foreach} {/if} {foreach from=$result key=k item=v}
                        <div class="col-xl-3 col-6 item-result__content">
                            <div class="card border-0">
                                <div class="card-body">
                                    <div class="product-list-recommend">
                                        <div class="item-img">
                                            ...
                                            <div class="owl-carousel owl__product-search">
                                                {foreach from=$v.a_img item=img}
                                                <div class="item">
                                                    <a href="{$v.url}"><img data-src="{$img}" class="img-fluid zoom-in" loading="lazy"></a>
                                                </div>
                                                {/foreach}
                                            </div>
                                            {else}
                                            <div class="item">
                                                <a href="{$v.url}"><img data-src="{$v.a_img[0]}" class="img-fluid zoom-in" loading="lazy"></a>
                                            </div>
                                            {/if}
                                        </div>
                                        <div class="search-item-info">
                                            {if $v.isimport eq 1}
                                            <span class="import_product_label">Nhập khẩu</span> {/if}
                                            ...
                                            <div class="seller-info d-none d-sm-block">
                                                <div class="media mb-2">
                                                    <div class="media-body">
                                                        <h3 class="mt-0 text-oneline seller-intro-title">
                                                            <a href="{$v.url_page}" title="{$v.metas.page}">{$v.metas.page}</a>
                                                        </h3>
                                                        <span class="yrs mr-2">
															<b
																class="number">{$v.metas.page_year|default:1}</b><small>YRS</small>
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="">
                                                    <a href="{$v.url_rfq}" class="btn btn-sm btn-contact rounded-pill">Liên
														hệ nhà cung
														cấp</a>
                                                </div>
                                                <div class="px-2 d-none d-sm-block">
                                                ...
                                                {if $out.isads eq 1}
                                                <span class="search-ads">Ads</span> {/if}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="item card rounded-8">
                        <div class="product-list-recommend">
                            ...
                            <div class="list-item-info">
                                ...
                                <p class="pt-1"><a href="{$v.url_page}?{$v.url_ads}" class="text-twoline" title="{$v.metas.page}">{$v.metas.page}</a>
                                </p>
