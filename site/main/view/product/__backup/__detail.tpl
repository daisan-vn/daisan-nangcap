                    ...
                    <div class="col-xl-5">
                        <div class="product__detail-info">
                            ...
                            <div class="product__detail-info2">
                                ...
                                <div>Giá tại: <a href="javascript:void(0)">{$page.province}</a><span class="fa fa-angle-down fa-fw"></span></div>
                                ...
                                {/if} {if $is_mobile}
                                <button type="button" class="btn btn-block btn-outline-secondary btn-add-to-cart" onclick="add_cart({$info.id});">
                                    Thêm vào giỏ hàng
                                </button>
                                <!--<button type="button" onclick="add_cart({$info.id},1);" class="btn btn-buy-now-button btn-block">
                                    Đặt Hàng Ngay
                                </button>
                                -->

                                <a href="?mod=page&site=contact&page_id={$page.id}&product_id={$info.id}" class="btn btn-buy-now-button btn-block">Gửi yêu cầu<br><span
                                    class="text-nm-1 text-b">Thông tin được gửi trực tiếp đến ncc</span></a>
                                <a href="tel:{$page.phone}" class="btn btn-info btn-block"><span class="text-sm">Gọi tư
                                        vấn giá mới nhất</span><br><span
                                        class="text-nm-1 text-b">{$page.phone}</span></a>{/if}
                                <!--
                                {if !$is_mobile}
                                <button type="button" class="btn btn-contact show_phone rounded-pill" onclick="SaveInfoCall({$info.id},0)"><i
										class="fa fa-volume-control-phone fa-fw"></i>
									Hiển thị số điện thoại
								</button> {/if}
                                <a href="javascript:void(0)" data-toggle="modal" data-target="#exampleModal" class="btn btn-info rounded-pill"><i class="fa fa-envelope-open-o fa-fw" aria-hidden="true"></i>Yêu cầu báo giá tốt hơn
								</a> -->
                                <div class="showroom">
                                    <p class="mb-2">Số lượng đặt hàng tối thiểu (MOD) <b>{$info.minorder}
                                            {$info.unit}</b></p>
                                ...
                                <div class="contact-supplier pt-2 pt-sm-0 d-block d-sm-none">
                                    <div class="row row-sm">
                                        ...
                                        <div class="col-6">
                                            <a href="tel:{$page.phone}" class="button btn-callnow" onclick="SaveInfoCall({$info.id},1)">GỌI NGAY</a>
                                        </div>
                                    </div>
                                </div>-->
                    ...
                    <div class="col-xl-3">
                        <div class="product__detail-seller">
                            <div class="seller_action mb-4">
                                ...
                                <a href="tel:1800 6464 98" class="btn btn-contact btn-block rounded-pill show_phone" onclick="SaveInfoCall({$info.id},1)"><i
                                        class="fa fa-volume-control-phone fa-fw"></i>
                            ...
                            <div class="card seller_info">
                                ...
                                <div class="card-body pt-3 pt-sm-5">
                                    ...
                                    <div class="seller_info-phone d-none d-sm-block">
                                        <a href="tel:{$page.phone}" class="btn btn-info btn-block rounded-pill"><span
                                                class="text-sm">Gọi tư vấn giá mới nhất</span><br><span
                                                class="text-nm-1 text-b">{$page.phone}</span></a>
                                    </div>
                                    <div class="d-flex justify-content-center mt-3 d-sm-none">
                                        <a href="?mod=page&site=contact&page_id={$page.id}&product_id={$info.id}" class="btn btn-contact-o mx-2">Liên hệ nhà cung
                                            cấp</a>
                                        <a href="{$page.url}" class="btn btn-contact mx-2">Đến gian
                                            hàng</a>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="details__info">
        <div class="container">
            <div class="row">
                ...
                <div class="col-xl-3">
                    <div class="">
                        <!-- Detail Product Daisanvn -->
                        <ins class="adsbygoogle" style="display:block" data-ad-client="ca-pub-7751440498976455" data-ad-slot="6188006736" data-ad-format="auto" data-full-width-responsive="true"></ins>
                        <script>
                            (adsbygoogle = window.adsbygoogle || []).push({});
                        </script>
                    </div>
...
{include file='../includes/phonecall.tpl'}
{include file='../includes/zalochat.tpl'}
