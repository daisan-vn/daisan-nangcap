            ...
            <ul class="nav">
				...
				<li class="nav-item dropdown dropdown-large ml-auto head_link_item"><a
					...
					<div class="dropdown-menu dropdown-menu-right dropdown-menu-large rounded-0"
								...
								<div class="row">
									...
									<div class="col-3">
										...
										<ul class="nav">
											...
											<li class="nav-item"><a href="{$sub.url}" target="_blank">{$sub.name}</a>
											</li>
											{/foreach}
										</ul>
									</div>
							...
							<div class="col-4 service-list">
								...
								<div class="card rounded-0 ">
									<ul class="list-unstyled">
										...
										{/foreach}
										{/if}
										{foreach from=$tax.menu_top key = k item=data}
											{if $k gt 9}
											<li class="media">
												<img src="{$data.image}" class="mr-3" style="width: 40px; height: 40px;">
												<div class="media-body">
						...
						<div class="row">
							<div class="col-12">
								<div class="text-center"><a href="./sitemap"><i class="fa fa-caret-right fa-fw"
											aria-hidden="true"></i>Xem danh sách dịch vụ</a></div>
							</div>
						</div>
					</div>
				</li>-->
            ...
            <nav class="navbar navbar-expand-lg">
                ...
                <div class="d-flex align-items-center ml-auto d-block d-sm-none">
                    <div class="p-2 bd-highlight">
                        {if $arg.login eq 0}
                        <a href="./login" class="">Đăng nhập </a> {else} Chào, <b><a href="?mod=account&site=index">{$hcache.user.name|truncate:10}</a></b> {/if}
                    </div>
                ...
                <div class="navbar-collapse" id="navbarSupportedContent">
                    <div class="form-search input-group my-2 my-lg-0">
                        ...
                        <input class="form-control" type="text" id="Keyword" value="{$main_filter.key|default:''}" placeholder="Nhập từ khóa tìm kiếm" oninput="onChangeSeach(this.value)" ;>
