            ...
            <nav class="navbar navbar-expand-lg">
                ...
                <div class="d-flex align-items-center ml-auto d-block d-sm-none">
                    <div class="p-2 bd-highlight">
                        {if $arg.login eq 0}
                        <a href="{$arg.url_account}login/?token={$arg.login_token}" class="">Đăng nhập </a> 
                    ...
                    <ul class="head_top--right navbar-nav ml-auto nav-right">
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-hover dropdown-menu-right" aria-labelledby="bd-versions">
                                {if $arg.login eq 0}
                                <a class="btn btn-warning btn-block mt-3" href="{$arg.url_account}login/?token={$arg.login_token}">Đăng nhập tài khoản</a>
                                <a class="btn btn-secondary btn-block mb-3" href="{$arg.url_account}register/?token={$arg.login_token}">Đăng ký tài khoản</a>
								...
								{else}
                                <a class="dropdown-item" href="{$arg.url_account}orders/">Quản lý mua hàng</a>
                                ...
                                <a class="dropdown-item" href="{$arg.url_account}shops/">Gian hàng bán</a>
                                <a class="dropdown-item" href="{$arg.url_account}create/">Khởi tạo gian hàng mới</a>
                                <a class="dropdown-item" href="{$arg.url_account}rfq/">Yêu cầu báo giá</a>
                                <a class="dropdown-item" href="{$arg.url_account}">Tài khoản của tôi</a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="{$arg.url_account}logout/?token={$arg.login_token}">Đăng xuất</a>
                                {/if}
                            </div>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{$arg.url_account}orders/">
