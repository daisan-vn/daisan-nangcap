    ...
    <script type="application/ld+json">
        {
            ...
            "image": "{$metadata.image|default:''}",
            "category": "{$info.category|default:''}",
            "productID": "{$info.code|default:''}",
            "identifier": "{$info.code|default:''}",
            "gtin": "{$info.code|default:''}",
            "mpn": "{$info.code|default:''}",
            "sku": "{$info.code|default:''}",
            "url": "{$arg.thislink|default:''}",
            "brand": {
                "@type": "Organization",
                "name": "{$info.trademark|default:''}",
                "url": "https://daisan.vn",
            ...
            "review": {
                ...
                "name": "{$metadata.title|default:''}",
                "author": "Daisan.vn",
                "datePublished": "{$info.created|default:''}",
                "description": "{$metadata.description|default:''}"
            },
            "offers": {
                "@type": "Offer",
                ...
                "url": "{$arg.thislink|default:''}",
                "priceCurrency": "VND",
                "price": "{$info.pricemin|default:''}",
                "priceValidUntil": "{$info.created|default:''}",
