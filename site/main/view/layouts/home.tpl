...
<head>
    ...
    <link href="{$arg.stylesheet}css/style_1.css" rel="stylesheet">
    ...
    <script type="application/ld+json">
        {
            ...
            "url": "https://daisan.vn",
            "name": "DaiSan",
            "logo": "https://static01.daisan.vn/site/upload/media/images/images/1626231253_3de4f98f18bb598659badc8e4607b308.png",
            "sameAs": [
                "https://www.facebook.com/daisanvn"
            ],
            "contactPoint": [{
                "@type": "ContactPoint",
                "telephone": "+84986 25 8282",
                "contactType": "customer service"
            }],
            "potentialAction": {
                "@type": "SearchAction",
                "target": "https://daisan.vn/result/product/?k={search_term_string}",
...
<body>
    ...
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-MMRDVW" height="0" width="0"
            style="display:none;visibility:hidden"></iframe></noscript>
    <!-- End Google Tag Manager (noscript) -->
    <div id="fb-root"></div>
    <div class="overlay"></div>
    {include file='../includes/header.tpl'} {include file=$content} {include file='../includes/footer.tpl'} {include file='../includes/hmenu.tpl'}
    <script>
    ...
    <script>
        var Swipes = new Swiper('.swiper-productcate', {
            loop: false,
            spaceBetween: 15,
            navigation: {
