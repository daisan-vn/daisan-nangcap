...
<div class="card-body">
	...
	<form method="post">
		...
		<div class="form-group row">
			...
			<div class="col-sm-4">
				<input type="text" name="url_facebook" class="form-control" value="{$profile.url_facebook|default:''}" placeholder="Url Facebook Page"> 
			</div>
			<div class="col-sm-4">
				<input type="text" name="fb_id" class="form-control" value="{$profile.fb_id|default:''}" placeholder=" Id  Facebook Chatbot">
			</div>
		</div>
		<div class="form-group row">
