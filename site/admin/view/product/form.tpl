    ...
    <div class="card mb-3">
        <div class="card-body">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control" name="ability" value="{$product.ability|default:''}"
            ...
            <div class="class" id="detailAttribute">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        ...
                        <select class="form-control selectpicker" name="detail_attribute_content_{$k+1}[]"
                            data-live-search="true" data-none-selected-text="Chọn" data-select-all-text="Chọn tất cả"
                            data-deselect-all-text="Bỏ tất cả" data-actions-box="true" multiple>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        ...
                        <input type="text" class="form-control" name="detail_attribute_content_{$k+1}"
                            value="{$v.content}">
                    </div>
                </div>
                {/if}
    ...
    <div class="panel panel-primary">
        <div class="panel-heading">
            <div class="row">
                ...
                <div class="col-md-4 text-right">
                    <button type="button" class="btn btn-light btn-sm" onclick="AddDetail();"><i
                            class="fa fa-plus fa-fw"></i>Thêm</button>
                </div>
            </div>
        </div>
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            <div class="mb-2">
                ...
                <small class="form-text text-muted"> Kích thước file ảnh tối đa 300Mb, hỗ trợ định dạng jpg,
                    png.</small>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <textarea class="form-control tinymce" id="post_content" name="description"
                        rows="12">{$product.description|default:''}</textarea>
                </div>
            </div>
    ...
    <div class="panel panel-primary">
        <div class="panel-heading">
            <div class="row">
                ...
                <div class="col-md-4 text-right">
                    <button type="button" class="btn btn-light btn-sm" onclick="AddPrice();"><i
                            class="fa fa-plus fa-fw"></i>Thêm</button>
                </div>
            </div>
        </div>
...
<script src="{$arg.stylesheet}custom/tinymce/tinymce.min.js"></script>
<script src="{$arg.stylesheet}custom/tinymce/tinymce.conf.js"></script>
