<div class="list-group-item list-group-item-action">
	...
	<i class="far fa-fw fa-dot-circle ml-3"></i> Tìm được: <b id="number">{$out.number_product|default:0}</b>SP
	<i class="far fa-fw fa-dot-circle ml-3"></i> Tổng SP: <b id="number">{$out.number|default:0}</b>SP
