...
<div class="card shadow">
	<div class="card-body py-4">
		...
		<div>
			<i class="far fa-fw fa-circle"></i> Trang: <b>{$db.name|default:''}</b>
			<i class="far fa-fw fa-globe mx-3"></i> Domain: <b>{$db.website|default:''}</b>
		...
		<div class="row row-sm" id="filter">
			...
			<div class="form-group col-md-3 col-12 mb-sm-0">
				<button type="button" class="btn btn-primary" id="start" onclick="scan_start();"><i class="fa fa-play"></i> START</button>
