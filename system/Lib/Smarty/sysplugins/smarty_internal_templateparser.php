...
// line 292 "../smarty/lexer/smarty_internal_templateparser.y"
    ...
    if (preg_match('/^(.*)(\s+nocache)$/', $var, $match)) {
        ...
        $this->_retvalue = $this->compiler->compileTag('private_print_expression',[],array('value'=>$this->compiler->compileVariable('\''.$var.'\'')));
    }
    }
// line 302 "../smarty/lexer/smarty_internal_templateparser.y"
    ...
    if ($tag == 'strip') {
        ...
        if (defined($tag)) {
            ...
            $this->_retvalue = $this->compiler->compileTag('private_print_expression',[],array('value'=>$tag));
        } else {
...
// line 323 "../smarty/lexer/smarty_internal_templateparser.y"
    ...
    if ($this->yystack[$this->yyidx + 0]->minor[$j+1] == 'c') {
        // {$smarty.block.child}
        $this->_retvalue = $this->compiler->compileTag('child',[],array($this->yystack[$this->yyidx + 0]->minor));
    } else {
        // {$smarty.block.parent}
       $this->_retvalue = $this->compiler->compileTag('parent',[],array($this->yystack[$this->yyidx + 0]->minor));
     }
    }
...
// line 388 "../smarty/lexer/smarty_internal_templateparser.y"
    public function yy_r25(){
        if (defined($this->yystack[$this->yyidx + 0]->minor)) {
            ...
            $this->_retvalue = $this->compiler->compileTag('private_print_expression',[],array('value'=>$this->yystack[$this->yyidx + 0]->minor));
        } else {
...
// line 428 "../smarty/lexer/smarty_internal_templateparser.y"
    ...
    $this->_retvalue = $this->compiler->compileTag(($tag === 'else if')? 'elseif' : $tag,[],array('if condition'=>$this->yystack[$this->yyidx + 0]->minor));
    }
...
// line 482 "../smarty/lexer/smarty_internal_templateparser.y"
    ...
    $this->_retvalue = $this->compiler->compileTag('setfilter',[],array('modifier_list'=>array(array_merge(array($this->yystack[$this->yyidx + -1]->minor),$this->yystack[$this->yyidx + 0]->minor))));
    }
// line 486 "../smarty/lexer/smarty_internal_templateparser.y"
    public function yy_r43(){
    $this->_retvalue = $this->compiler->compileTag('setfilter',[],array('modifier_list'=>array_merge(array(array_merge(array($this->yystack[$this->yyidx + -2]->minor),$this->yystack[$this->yyidx + -1]->minor)),$this->yystack[$this->yyidx + 0]->minor)));
    }
...
// line 505 "../smarty/lexer/smarty_internal_templateparser.y"
    ...
    $this->_retvalue = $this->compiler->compileTag($this->yystack[$this->yyidx + -1]->minor.'close',[],array('modifier_list'=>$this->yystack[$this->yyidx + 0]->minor));
    }
// line 510 "../smarty/lexer/smarty_internal_templateparser.y"
    public function yy_r47(){
    $this->_retvalue = $this->compiler->compileTag($this->yystack[$this->yyidx + -2]->minor.'close',[],array('object_method'=>$this->yystack[$this->yyidx + 0]->minor));
    }
// line 514 "../smarty/lexer/smarty_internal_templateparser.y"
    public function yy_r48(){
    $this->_retvalue = $this->compiler->compileTag($this->yystack[$this->yyidx + -3]->minor.'close',[],array('object_method'=>$this->yystack[$this->yyidx + -1]->minor, 'modifier_list'=>$this->yystack[$this->yyidx + 0]->minor));
    }
...
// line 767 "../smarty/lexer/smarty_internal_templateparser.y"
    ...
    $this->_retvalue = $this->compiler->compileTag('private_modifier',[],array('value'=>$this->yystack[$this->yyidx + -1]->minor,'modifierlist'=>$this->yystack[$this->yyidx + 0]->minor));
    }
