...
class Text {
	 ...
	 * @return string
	 */
	public function quotes_to_entities($str) {
		return str_replace ( array (
				"\'",
				"\"",
				"'",
	...
	/**
	 * Word Censoring public function
	 *
	...
	public function highlight_code($str) {
		/*
		 * The highlight string public function encodes and highlights
		...
		// The highlight_string public function requires that the text be surrounded
	 ...
	 * Ellipsize String
	 *
	 * This public function will strip tags from a string, split it at its max_length and ellipsize
	 *
	 * @param
	...
	public function str_convert($str, $prefix="-"){
	...
	public function del_danger($str) {
		$str = preg_replace("/[\\\'\"`{}<>]/", "", $str);
		return $str;
	}
	 ...
	 * @return string
	 */
	public function arr_to_ini(array $a, array $parent = []){
		$out = '';
		foreach ($a as $k => $v){
			if (is_array($v)){
	...
	public function convert_money_to_int($value){
	...
	public function encrypt_string($value) {
	...
	public function get_position_ofstr_byprefix($str, $prefix, $position=0){
	...
	public function get_value_of_endstr($str){
	    $a_str = explode(" ", $str);
	    return end($a_str);
	}
}
